...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("part-list", Namespace = "", IsNullable = true)]
    public class PartList
    {
        ...
        public static bool Deserialize(string xml, out PartList obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((PartList) (MemberwiseClone()));
        }
