...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("measure-numbering", Namespace = "", IsNullable = true)]
    public class MeasureNumbering
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (MeasureNumbering));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out MeasureNumbering obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((MeasureNumbering) (MemberwiseClone()));
        }
