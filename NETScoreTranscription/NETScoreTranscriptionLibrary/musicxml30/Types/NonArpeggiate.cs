...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("non-arpeggiate", Namespace = "", IsNullable = true)]
    public class NonArpeggiate
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (NonArpeggiate));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out NonArpeggiate obj, out Exception exception)
        {
            exception = null;
