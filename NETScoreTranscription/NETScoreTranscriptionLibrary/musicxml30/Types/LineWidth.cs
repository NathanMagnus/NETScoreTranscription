...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("line-width", Namespace = "", IsNullable = true)]
    public class LineWidth
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (LineWidth));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out LineWidth obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((LineWidth) (MemberwiseClone()));
        }
