...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("accidental-mark", Namespace = "", IsNullable = true)]
    public class AccidentalMark
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (AccidentalMark));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out AccidentalMark obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((AccidentalMark) (MemberwiseClone()));
        }
