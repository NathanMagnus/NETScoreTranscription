...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("empty-placement", Namespace = "", IsNullable = true)]
    public class EmptyPlacement
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (EmptyPlacement));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out EmptyPlacement obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((EmptyPlacement) (MemberwiseClone()));
        }
