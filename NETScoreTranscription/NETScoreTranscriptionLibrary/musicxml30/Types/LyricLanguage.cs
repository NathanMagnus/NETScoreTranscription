...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("lyric-language", Namespace = "", IsNullable = true)]
    public class LyricLanguage
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (LyricLanguage));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out LyricLanguage obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((LyricLanguage) (MemberwiseClone()));
        }
