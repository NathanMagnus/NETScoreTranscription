...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("hammer-on-pull-off", Namespace = "", IsNullable = true)]
    public class HammeronPulloff
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (HammeronPulloff));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out HammeronPulloff obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((HammeronPulloff) (MemberwiseClone()));
        }
