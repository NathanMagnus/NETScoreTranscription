...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Degree
    {
        ...
        [XmlElement("degree-value", Order = 0)]
        ...
        [XmlElement("degree-alter", Order = 1)]
        ...
        [XmlElement("degree-type", Order = 2)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Degree));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Degree obj, out Exception exception)
        {
            exception = null;
            obj = default(Degree);
            try
