    ...
    public class Bass
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Bass));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Bass obj, out Exception exception)
        {
            exception = null;
            obj = default(Bass);
            try
