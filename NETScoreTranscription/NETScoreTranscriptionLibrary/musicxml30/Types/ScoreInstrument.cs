...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("score-instrument", Namespace = "", IsNullable = true)]
    public class ScoreInstrument
    {
        ...
        [XmlElement("instrument-name", Order = 0)]
        ...
        [XmlElement("instrument-abbreviation", Order = 1)]
        ...
        [XmlElement("instrument-sound", Order = 2)]
        ...
        [XmlElement("ensemble", typeof (string), Order = 3)]
        [XmlElement("solo", typeof (Empty), Order = 3)]
        public object Item
        {
        ...
        [XmlElement("virtual-instrument", Order = 4)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (ScoreInstrument));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out ScoreInstrument obj, out Exception exception)
        {
            exception = null;
