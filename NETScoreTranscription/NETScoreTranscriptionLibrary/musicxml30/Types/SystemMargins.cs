...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("system-margins", Namespace = "", IsNullable = true)]
    public class SystemMargins
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (SystemMargins));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out SystemMargins obj, out Exception exception)
        {
            exception = null;
