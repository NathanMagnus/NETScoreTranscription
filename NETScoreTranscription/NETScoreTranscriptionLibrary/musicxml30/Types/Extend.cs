    ...
    public class Extend
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Extend));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Extend obj, out Exception exception)
        {
            exception = null;
            obj = default(Extend);
            try
