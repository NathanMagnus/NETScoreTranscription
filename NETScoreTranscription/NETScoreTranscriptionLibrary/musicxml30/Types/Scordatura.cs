    ...
    public class Scordatura
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Scordatura));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Scordatura obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((Scordatura) (MemberwiseClone()));
        }
