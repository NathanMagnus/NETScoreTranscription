...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("virtual-instrument", Namespace = "", IsNullable = true)]
    public class VirtualInstrument
    {
        ...
        [XmlElement("virtual-library", Order = 0)]
        ...
        [XmlElement("virtual-name", Order = 1)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (VirtualInstrument));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out VirtualInstrument obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((VirtualInstrument) (MemberwiseClone()));
        }
