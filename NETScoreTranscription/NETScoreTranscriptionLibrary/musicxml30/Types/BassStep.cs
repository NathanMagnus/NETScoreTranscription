...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("bass-step", Namespace = "", IsNullable = true)]
    public class BassStep
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (BassStep));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out BassStep obj, out Exception exception)
        {
            exception = null;
