...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("breath-mark", Namespace = "", IsNullable = true)]
    public class Breathmark
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Breathmark));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Breathmark obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((Breathmark) (MemberwiseClone()));
        }
