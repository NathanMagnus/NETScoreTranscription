...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("style-text", Namespace = "", IsNullable = true)]
    public class StyleText
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (StyleText));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out StyleText obj, out Exception exception)
        {
            exception = null;
