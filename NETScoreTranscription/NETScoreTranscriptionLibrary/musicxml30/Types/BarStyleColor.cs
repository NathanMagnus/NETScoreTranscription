...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("bar-style-color", Namespace = "", IsNullable = true)]
    public class BarStyleColor
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (BarStyleColor));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out BarStyleColor obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((BarStyleColor) (MemberwiseClone()));
        }
