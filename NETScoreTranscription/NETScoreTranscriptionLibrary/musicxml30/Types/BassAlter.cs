...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("bass-alter", Namespace = "", IsNullable = true)]
    public class BassAlter
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (BassAlter));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out BassAlter obj, out Exception exception)
        {
            exception = null;
        ...
        /// <param name = "exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out BassAlter obj, out Exception exception)
        {
            exception = null;
            obj = default(BassAlter);
            try
        ...
        {
            return ((BassAlter) (MemberwiseClone()));
        }
