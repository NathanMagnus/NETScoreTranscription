    ...
    public class Inversion
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Inversion));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Inversion obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((Inversion) (MemberwiseClone()));
        }
