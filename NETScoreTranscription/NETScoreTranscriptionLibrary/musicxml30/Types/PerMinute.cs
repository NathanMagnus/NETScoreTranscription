...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("per-minute", Namespace = "", IsNullable = true)]
    public class PerMinute
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (PerMinute));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out PerMinute obj, out Exception exception)
        {
            exception = null;
