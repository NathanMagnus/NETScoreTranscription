...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Root
    {
        ...
        [XmlElement("root-step", Order = 0)]
        public RootStep rootStep
        {
            get { return rootStepField; }
            set { rootStepField = value; }
        }

        [XmlElement("root-alter", Order = 1)]
        public RootAlter rootAlter
        {
            get { return rootAlterField; }
            set { rootAlterField = value; }
        }
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Root));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Root obj, out Exception exception)
        {
            exception = null;
            obj = default(Root);
            try
