    ...
    public class Handbell
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Handbell));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Handbell obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((Handbell) (MemberwiseClone()));
        }
