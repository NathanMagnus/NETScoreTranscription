...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("empty-print-object-style-align", Namespace = "", IsNullable = true)]
    public class EmptyPrintObjectStyleAlign
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (EmptyPrintObjectStyleAlign));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out EmptyPrintObjectStyleAlign obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((EmptyPrintObjectStyleAlign) (MemberwiseClone()));
        }
