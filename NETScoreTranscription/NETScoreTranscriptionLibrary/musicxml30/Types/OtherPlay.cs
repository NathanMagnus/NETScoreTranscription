...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("other-play", Namespace = "", IsNullable = true)]
    public class OtherPlay
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (OtherPlay));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out OtherPlay obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((OtherPlay) (MemberwiseClone()));
        }
