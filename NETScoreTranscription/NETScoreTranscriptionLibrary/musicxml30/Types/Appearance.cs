...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Appearance
    {
        ...
        [XmlElement("other-appearance", Order = 3)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Appearance));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Appearance obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((Appearance) (MemberwiseClone()));
        }
