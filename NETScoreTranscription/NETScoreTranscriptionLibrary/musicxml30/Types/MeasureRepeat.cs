...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("measure-repeat", Namespace = "", IsNullable = true)]
    public class MeasureRepeat
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (MeasureRepeat));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out MeasureRepeat obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((MeasureRepeat) (MemberwiseClone()));
        }
