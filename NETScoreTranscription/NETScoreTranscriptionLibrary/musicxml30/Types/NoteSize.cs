...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("note-size", Namespace = "", IsNullable = true)]
    public class NoteSize
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (NoteSize));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out NoteSize obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((NoteSize) (MemberwiseClone()));
        }
