...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("system-dividers", Namespace = "", IsNullable = true)]
    public class SystemDividers
    {
        ...
        [XmlElement("left-divider", Order = 0)]
        ...
        [XmlElement("right-divider", Order = 1)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (SystemDividers));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out SystemDividers obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((SystemDividers) (MemberwiseClone()));
        }
