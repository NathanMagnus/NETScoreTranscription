    ...
    public class Cancel
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Cancel));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Cancel obj, out Exception exception)
        {
            exception = null;
            obj = default(Cancel);
            try
