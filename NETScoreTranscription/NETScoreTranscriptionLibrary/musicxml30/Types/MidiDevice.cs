...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("midi-device", Namespace = "", IsNullable = true)]
    public class MidiDevice
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (MidiDevice));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out MidiDevice obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((MidiDevice) (MemberwiseClone()));
        }
