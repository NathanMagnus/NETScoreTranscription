...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("degree-type", Namespace = "", IsNullable = true)]
    public class DegreeType
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (DegreeType));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out DegreeType obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((DegreeType) (MemberwiseClone()));
        }
