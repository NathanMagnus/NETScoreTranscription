    ...
    public class Supports
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Supports));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Supports obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((Supports) (MemberwiseClone()));
        }
