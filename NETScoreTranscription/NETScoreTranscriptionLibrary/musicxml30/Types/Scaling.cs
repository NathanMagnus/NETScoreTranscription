    ...
    public class Scaling
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Scaling));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Scaling obj, out Exception exception)
        {
            exception = null;
            obj = default(Scaling);
            try
        ...
        {
            return ((Scaling) (MemberwiseClone()));
        }
