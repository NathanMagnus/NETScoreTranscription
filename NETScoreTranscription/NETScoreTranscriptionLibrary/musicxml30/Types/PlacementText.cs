...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("placement-text", Namespace = "", IsNullable = true)]
    public class PlacementText
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (PlacementText));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out PlacementText obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((PlacementText) (MemberwiseClone()));
        }
