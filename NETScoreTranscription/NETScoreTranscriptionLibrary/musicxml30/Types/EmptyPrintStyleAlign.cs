...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("empty-print-style-align", Namespace = "", IsNullable = true)]
    public class EmptyPrintStyleAlign
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (EmptyPrintStyleAlign));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out EmptyPrintStyleAlign obj, out Exception exception)
        {
            exception = null;
        ...
        /// <param name = "exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out EmptyPrintStyleAlign obj, out Exception exception)
        {
            exception = null;
            obj = default(EmptyPrintStyleAlign);
            try
        ...
        {
            return ((EmptyPrintStyleAlign) (MemberwiseClone()));
        }
