...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("miscellaneous-field", Namespace = "", IsNullable = true)]
    public class MiscellaneousField
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (MiscellaneousField));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out MiscellaneousField obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((MiscellaneousField) (MemberwiseClone()));
        }
