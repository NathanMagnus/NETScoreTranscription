...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("other-appearance", Namespace = "", IsNullable = true)]
    public class OtherAppearance
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (OtherAppearance));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out OtherAppearance obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((OtherAppearance) (MemberwiseClone()));
        }
