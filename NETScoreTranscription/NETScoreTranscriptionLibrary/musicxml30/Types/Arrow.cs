...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Arrow
    {
        ...
        [XmlElement("arrow-direction", typeof (ArrowDirection), Order = 0)]
        [XmlElement("arrow-style", typeof (ArrowStyle), Order = 0)]
        [XmlElement("circular-arrow", typeof (CircularArrow), Order = 0)]
        public object[] Items
        {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Arrow));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Arrow obj, out Exception exception)
        {
            exception = null;
            obj = default(Arrow);
            try
