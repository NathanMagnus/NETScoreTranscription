...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("formatted-text", Namespace = "", IsNullable = true)]
    public class FormattedText
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (FormattedText));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out FormattedText obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((FormattedText) (MemberwiseClone()));
        }
