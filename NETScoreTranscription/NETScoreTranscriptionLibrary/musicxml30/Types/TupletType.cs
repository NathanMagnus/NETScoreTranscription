...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("tuplet-type", Namespace = "", IsNullable = true)]
    public class TupletType
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (TupletType));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out TupletType obj, out Exception exception)
        {
            exception = null;
