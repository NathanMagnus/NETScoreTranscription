...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Mordent : EmptyTrillSound
    {
        ...
        public bool longSpecified
        {
            get
            {
                return longFieldSpecified;
            }
            set
            {
                longFieldSpecified = value;
            }
        }
        ...
        public bool approachSpecified
        {
            get
            {
                return approachFieldSpecified;
            }
            set
            {
                approachFieldSpecified = value;
            }
        }
        ...
        public bool departureSpecified
        {
            get
            {
                return departureFieldSpecified;
            }
            set
            {
                departureFieldSpecified = value;
            }
        }
        ...
        {
            return ((Mordent)(MemberwiseClone()));
        }
        #endregion
    }
}