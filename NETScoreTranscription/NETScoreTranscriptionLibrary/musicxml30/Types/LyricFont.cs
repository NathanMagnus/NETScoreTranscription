...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("lyric-font", Namespace = "", IsNullable = true)]
    public class LyricFont
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (LyricFont));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out LyricFont obj, out Exception exception)
        {
            exception = null;
