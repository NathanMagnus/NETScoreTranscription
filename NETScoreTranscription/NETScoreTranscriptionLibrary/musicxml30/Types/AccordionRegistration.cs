...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("accordion-registration", Namespace = "", IsNullable = true)]
    public class AccordionRegistration
    {
        ...
        [XmlElement("accordion-high", Order = 0)]
        ...
        [XmlElement("accordion-middle", DataType = "positiveInteger", Order = 1)]
        ...
        [XmlElement("accordion-low", Order = 2)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (AccordionRegistration));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out AccordionRegistration obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((AccordionRegistration) (MemberwiseClone()));
        }
