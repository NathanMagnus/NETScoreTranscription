...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("degree-value", Namespace = "", IsNullable = true)]
    public class DegreeValue
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (DegreeValue));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out DegreeValue obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((DegreeValue) (MemberwiseClone()));
        }
