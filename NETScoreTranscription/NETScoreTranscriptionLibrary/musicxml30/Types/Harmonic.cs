...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Harmonic
    {
        ...
        [XmlElement("artificial", typeof (Empty), Order = 0)]
        [XmlElement("natural", typeof (Empty), Order = 0)]
        ...
        [XmlElement("base-pitch", typeof (Empty), Order = 2)]
        [XmlElement("sounding-pitch", typeof (Empty), Order = 2)]
        [XmlElement("touching-pitch", typeof (Empty), Order = 2)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Harmonic));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Harmonic obj, out Exception exception)
        {
            exception = null;
