    ...
    public class Beater
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Beater));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Beater obj, out Exception exception)
        {
            exception = null;
            obj = default(Beater);
            try
