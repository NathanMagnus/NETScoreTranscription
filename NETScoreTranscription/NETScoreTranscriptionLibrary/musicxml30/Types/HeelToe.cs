...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("heel-toe", Namespace = "", IsNullable = true)]
    public class HeelToe : EmptyPlacement
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (HeelToe));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out HeelToe obj, out Exception exception)
        {
            exception = null;
            obj = default(HeelToe);
            try
        ...
        {
            return ((HeelToe) (MemberwiseClone()));
        }
