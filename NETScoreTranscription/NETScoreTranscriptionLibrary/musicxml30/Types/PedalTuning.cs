...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("pedal-tuning", Namespace = "", IsNullable = true)]
    public class PedalTuning
    {
        ...
        [XmlElement("pedal-alter", Order = 1)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (PedalTuning));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out PedalTuning obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((PedalTuning) (MemberwiseClone()));
        }
