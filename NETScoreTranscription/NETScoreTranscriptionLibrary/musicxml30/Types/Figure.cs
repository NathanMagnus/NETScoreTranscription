...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Figure
    {
        ...
        [XmlElement("figure-number", Order = 1)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Figure));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Figure obj, out Exception exception)
        {
            exception = null;
            obj = default(Figure);
            try
