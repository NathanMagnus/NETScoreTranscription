...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("staff-tuning", Namespace = "", IsNullable = true)]
    public class StaffTuning
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (StaffTuning));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out StaffTuning obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((StaffTuning) (MemberwiseClone()));
        }
