...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("strong-accent", Namespace = "", IsNullable = true)]
    public class StrongAccent : EmptyPlacement
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (StrongAccent));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out StrongAccent obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((StrongAccent) (MemberwiseClone()));
        }
