...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("hole-closed", Namespace = "", IsNullable = true)]
    public class HoleClosed
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (HoleClosed));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out HoleClosed obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((HoleClosed) (MemberwiseClone()));
        }
