...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("metronome-note", Namespace = "", IsNullable = true)]
    public class MetronomeNote
    {
        ...
        [XmlElement("metronome-type", Order = 0)]
        ...
        [XmlElement("metronome-dot", Order = 1)]
        ...
        [XmlElement("metronome-beam", Order = 2)]
        ...
        [XmlElement("metronome-tuplet", Order = 3)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (MetronomeNote));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out MetronomeNote obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((MetronomeNote) (MemberwiseClone()));
        }
