...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class MetronomeNote
    {
        ...
        public NoteTypeValue metronomeType
        {
            get
            {
                return metronomeTypeField;
            }
            set
            {
                metronomeTypeField = value;
            }
        }
        ...
        public Empty[] metronomeDot
        {
            get
            {
                return metronomeDotField;
            }
            set
            {
                metronomeDotField = value;
            }
        }
        ...
        public MetronomeBeam[] metronomebeam
        {
            get
            {
                return metronomebeamField;
            }
            set
            {
                metronomebeamField = value;
            }
        }
        ...
        public MetronomeTuplet metronomeTuplet
        {
            get
            {
                return metronomeTupletField;
            }
            set
            {
                metronomeTupletField = value;
            }
        }
