...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Encoding
    {
        ...
        [XmlElement("encoder", typeof (TypedText), Order = 0)]
        [XmlElement("encoding-date", typeof (DateTime), DataType = "date", Order = 0)]
        [XmlElement("encoding-description", typeof (string), Order = 0)]
        [XmlElement("software", typeof (string), Order = 0)]
        [XmlElement("supports", typeof (Supports), Order = 0)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Encoding));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Encoding obj, out Exception exception)
        {
            exception = null;
