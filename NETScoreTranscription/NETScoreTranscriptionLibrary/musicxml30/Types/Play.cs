...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Play
    {
        ...
        [XmlElement("ipa", typeof (string), Order = 0)]
        [XmlElement("mute", typeof (Mute), Order = 0)]
        [XmlElement("other-play", typeof (OtherPlay), Order = 0)]
        [XmlElement("semi-pitched", typeof (SemiPitched), Order = 0)]
        public object[] Items
        {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Play));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Play obj, out Exception exception)
        {
            exception = null;
            obj = default(Play);
            try
