...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("empty-font", Namespace = "", IsNullable = true)]
    public class EmptyFont
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (EmptyFont));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out EmptyFont obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((EmptyFont) (MemberwiseClone()));
        }
