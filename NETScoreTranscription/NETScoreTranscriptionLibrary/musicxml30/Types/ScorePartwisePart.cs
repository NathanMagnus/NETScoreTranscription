    ...
    public class ScorePartwisePart
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (ScorePartwisePart));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out ScorePartwisePart obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((ScorePartwisePart) (MemberwiseClone()));
        }
