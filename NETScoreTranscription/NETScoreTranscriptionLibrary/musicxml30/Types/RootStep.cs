...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("root-step", Namespace = "", IsNullable = true)]
    public class RootStep
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (RootStep));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out RootStep obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((RootStep) (MemberwiseClone()));
        }
