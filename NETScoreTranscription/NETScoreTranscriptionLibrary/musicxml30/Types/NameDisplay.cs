...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("name-display", Namespace = "", IsNullable = true)]
    public class NameDisplay
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (NameDisplay));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out NameDisplay obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((NameDisplay) (MemberwiseClone()));
        }
