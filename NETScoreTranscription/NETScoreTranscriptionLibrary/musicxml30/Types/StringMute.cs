...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("string-mute", Namespace = "", IsNullable = true)]
    public class StringMute
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (StringMute));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out StringMute obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((StringMute) (MemberwiseClone()));
        }
