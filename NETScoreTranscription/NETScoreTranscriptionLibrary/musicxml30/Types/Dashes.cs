    ...
    public class Dashes
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Dashes));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Dashes obj, out Exception exception)
        {
            exception = null;
            obj = default(Dashes);
            try
