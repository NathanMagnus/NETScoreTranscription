...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Unpitched
    {
        ...
        [XmlElement("display-step", Order = 0)]
        ...
        [XmlElement("display-octave", DataType = "integer", Order = 1)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Unpitched));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Unpitched obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((Unpitched) (MemberwiseClone()));
        }
