...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("first-fret", Namespace = "", IsNullable = true)]
    public class FirstFret
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (FirstFret));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out FirstFret obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((FirstFret) (MemberwiseClone()));
        }
