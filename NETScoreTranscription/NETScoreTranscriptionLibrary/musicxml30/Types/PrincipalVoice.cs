...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("principal-voice", Namespace = "", IsNullable = true)]
    public class PrincipalVoice
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (PrincipalVoice));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out PrincipalVoice obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((PrincipalVoice) (MemberwiseClone()));
        }
