...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("page-layout", Namespace = "", IsNullable = true)]
    public class PageLayout
    {
        ...
        [XmlElement("page-height", Order = 0)]
        ...
        [XmlElement("page-margins", Order = 2)]
        ...
        public static bool Deserialize(string xml, out PageLayout obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((PageLayout) (MemberwiseClone()));
        }
