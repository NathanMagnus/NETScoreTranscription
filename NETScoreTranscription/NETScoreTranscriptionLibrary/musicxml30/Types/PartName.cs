...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("part-name", Namespace = "", IsNullable = true)]
    public class PartName
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (PartName));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out PartName obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((PartName) (MemberwiseClone()));
        }
