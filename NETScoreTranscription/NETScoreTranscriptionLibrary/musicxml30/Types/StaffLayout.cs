...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("staff-layout", Namespace = "", IsNullable = true)]
    public class StaffLayout
    {
        ...
        [XmlElement("staff-distance", Order = 0)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (StaffLayout));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out StaffLayout obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((StaffLayout) (MemberwiseClone()));
        }
