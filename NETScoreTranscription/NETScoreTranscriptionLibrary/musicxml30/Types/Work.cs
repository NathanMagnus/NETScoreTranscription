...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Work
    {
        ...
        [XmlElement("work-number", Order = 0)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Work));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Work obj, out Exception exception)
        {
            exception = null;
            obj = default(Work);
            try
