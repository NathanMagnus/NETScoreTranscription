...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("harp-pedals", Namespace = "", IsNullable = true)]
    public class HarpPedals
    {
        private static XmlSerializer serializer;
        private PedalTuning[] pedalTuningField;

        [XmlElement("pedal-tuning", Order = 0)]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (HarpPedals));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out HarpPedals obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((HarpPedals) (MemberwiseClone()));
        }
