    ...
    public class Arpeggiate
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Arpeggiate));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Arpeggiate obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((Arpeggiate) (MemberwiseClone()));
        }
