...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class ScorePartwise
    {
        ...
        [XmlElement("part", Order = 7)]
        public ScorePartwisePart[] part { get; set; }

        [XmlAttribute(DataType = "token"), DefaultValue("1.0")]
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (ScorePartwise));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out ScorePartwise obj, out Exception exception)
        {
            exception = null;
