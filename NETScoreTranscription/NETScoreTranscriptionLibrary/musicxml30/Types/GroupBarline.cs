...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("group-barline", Namespace = "", IsNullable = true)]
    public class GroupBarline
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (GroupBarline));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out GroupBarline obj, out Exception exception)
        {
            exception = null;
