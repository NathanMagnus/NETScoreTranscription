    ...
    public class Distance
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Distance));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Distance obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((Distance) (MemberwiseClone()));
        }
