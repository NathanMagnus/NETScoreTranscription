...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("empty-print-style", Namespace = "", IsNullable = true)]
    public class EmptyPrintStyle
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (EmptyPrintStyle));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out EmptyPrintStyle obj, out Exception exception)
        {
            exception = null;
        ...
        /// <param name = "exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out EmptyPrintStyle obj, out Exception exception)
        {
            exception = null;
            obj = default(EmptyPrintStyle);
            try
        ...
        {
            return ((EmptyPrintStyle) (MemberwiseClone()));
        }
