...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("other-notation", Namespace = "", IsNullable = true)]
    public class OtherNotation
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (OtherNotation));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out OtherNotation obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((OtherNotation) (MemberwiseClone()));
        }
