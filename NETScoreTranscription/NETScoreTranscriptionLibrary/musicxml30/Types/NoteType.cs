...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("note-type", Namespace = "", IsNullable = true)]
    public class NoteType
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (NoteType));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out NoteType obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((NoteType) (MemberwiseClone()));
        }
