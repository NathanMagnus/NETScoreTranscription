...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Miscellaneous
    {
        ...
        [XmlElement("miscellaneous-field", Order = 0)]
        public MiscellaneousField[] miscellaneousField
        {
            get { return miscellaneousFieldField; }
            set { miscellaneousFieldField = value; }
        }
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Miscellaneous));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Miscellaneous obj, out Exception exception)
        {
            exception = null;
        ...
        /// <param name = "exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out Miscellaneous obj, out Exception exception)
        {
            exception = null;
            obj = default(Miscellaneous);
            try
