...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("typed-text", Namespace = "", IsNullable = true)]
    public class TypedText
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (TypedText));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out TypedText obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((TypedText) (MemberwiseClone()));
        }
