    ...
    public class Bracket
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (Bracket));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Bracket obj, out Exception exception)
        {
            exception = null;
            obj = default(Bracket);
            try
        ...
        {
            return ((Bracket) (MemberwiseClone()));
        }
