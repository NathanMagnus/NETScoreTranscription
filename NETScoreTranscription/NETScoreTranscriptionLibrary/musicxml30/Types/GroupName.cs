...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    [XmlRoot("group-name", Namespace = "", IsNullable = true)]
    public class GroupName
    {
        ...
        private static XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new XmlSerializer(typeof (GroupName));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out GroupName obj, out Exception exception)
        {
            exception = null;
        ...
        {
            return ((GroupName) (MemberwiseClone()));
        }
