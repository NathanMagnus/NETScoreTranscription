...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class Grace
    {
        ...
        public decimal stealTimePrevious
        {
            get
            {
                return stealTimePreviousField;
            }
            set
            {
                stealTimePreviousField = value;
            }
        }
        ...
        public bool stealTimePreviousSpecified
        {
            get
            {
                return stealTimePreviousFieldSpecified;
            }
            set
            {
                stealTimePreviousFieldSpecified = value;
            }
        }
        ...
        public decimal stealTimeFollowing
        {
            get
            {
                return stealTimeFollowingField;
            }
            set
            {
                stealTimeFollowingField = value;
            }
        }
        ...
        public bool stealTimeFollowingSpecified
        {
            get
            {
                return stealTimeFollowingFieldSpecified;
            }
            set
            {
                stealTimeFollowingFieldSpecified = value;
            }
        }
        ...
        public bool makeTimeSpecified
        {
            get
            {
                return makeTimeFieldSpecified;
            }
            set
            {
                makeTimeFieldSpecified = value;
            }
        }
        ...
        public bool slashSpecified
        {
            get
            {
                return slashFieldSpecified;
            }
            set
            {
                slashFieldSpecified = value;
            }
        }
