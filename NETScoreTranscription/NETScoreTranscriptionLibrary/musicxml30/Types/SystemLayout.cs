...
namespace NETScoreTranscriptionLibrary.musicxml30.Types
{
    ...
    public class SystemLayout
    {
        ...
        public SystemMargins systemMargins
        {
            get
            {
                return systemMarginsField;
            }
            set
            {
                systemMarginsField = value;
            }
        }
        ...
        public decimal systemDistance
        {
            get
            {
                return systemDistanceField;
            }
            set
            {
                systemDistanceField = value;
            }
        }
        ...
        public bool systemDistanceSpecified
        {
            get
            {
                return systemDistanceFieldSpecified;
            }
            set
            {
                systemDistanceFieldSpecified = value;
            }
        }
        ...
        public decimal topSystemDistance
        {
            get
            {
                return topSystemDistanceField;
            }
            set
            {
                topSystemDistanceField = value;
            }
        }
        ...
        public bool topSystemDistanceSpecified
        {
            get
            {
                return topSystemDistanceFieldSpecified;
            }
            set
            {
                topSystemDistanceFieldSpecified = value;
            }
        }
        ...
        public SystemDividers systemDividers
        {
            get
            {
                return systemDividersField;
            }
            set
            {
                systemDividersField = value;
            }
        }
