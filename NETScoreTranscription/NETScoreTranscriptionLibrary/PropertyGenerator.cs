...
namespace NETScoreTranscriptionLibrary
{
    public static class PropertyGenerator
    {
        ...
        /// <summary>
        /// Generate the information for all properties of a class
        /// </summary>
        /// <param name="myType">The type of the class</param>
        /// <param name="caller">The class to display the properties of</param>
        /// <returns>String of the properties of the class</returns>
