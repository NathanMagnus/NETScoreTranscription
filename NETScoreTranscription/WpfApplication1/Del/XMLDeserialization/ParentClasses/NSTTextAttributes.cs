...
namespace NETScoreTranscriptionLibrary.XMLDeserialization.ParentClasses
{
    public class NSTTextAttributes//todo: ensure that inheritance proper
    {
        ...
        //todo: put in proper order from above
